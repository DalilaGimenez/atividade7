# Atividade 7
Instruções: Utilizando os componentes do Chakra ajuste a página de tarefas para ficar similar ao modelo apresentado a seguir (lembre-se de componentizar o código)
O modelo está no último slide da aula 3 - React
